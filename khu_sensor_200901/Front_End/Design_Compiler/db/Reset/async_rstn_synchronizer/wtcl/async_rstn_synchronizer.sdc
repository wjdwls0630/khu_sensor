...
# Created by write_sdc on Wed Aug 26 17:12:03 2020
...
[get_ports i_CLK]
set_wire_load_model -min -name l13_e_50k_4lm -library std150e_wst_105_p125     \
[get_ports i_CLK]
set_wire_load_model -name l13_e_50k_4lm -library std150e_wst_105_p125          \
[get_ports i_RSTN]
set_wire_load_model -min -name l13_e_50k_4lm -library std150e_wst_105_p125     \
...
set_load -min -pin_load 0.02652 [get_ports o_RSTN]
