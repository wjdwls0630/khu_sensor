...
report_dont_touch > "${log_path}${dir}${t_w_path}${design}_report_dont_touch.rpt"
...
report_net -connection -verbose > "${log_path}${dir}${t_w_path}${design}_report_net_connection.rpt"
...
report_timing -max_path 10 > "${log_path}${dir}${t_w_path}${design}_report_timing_max_path.rpt"
...
report_timing -delay min -nworst 5 > "${log_path}${dir}${t_w_path}${design}_report_timing_delay_min.rpt"
