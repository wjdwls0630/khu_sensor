...
set_timing_derate -late  -data  $_derate(wst,late,data)
set_timing_derate -late  -clock $_derate(wst,late,clock)
...
if {[sizeof $FF] > 0} {
  foreach hvt_ff_cell [get_object_name $FF] {
           set_clock_uncertainty -hold $FF_WST_HOLD_MARGIN [get_pins -of $hvt_ff_cell -filter "lib_pin_name =~ *CK* || lib_pin_name =~ G*"]
  }
}
