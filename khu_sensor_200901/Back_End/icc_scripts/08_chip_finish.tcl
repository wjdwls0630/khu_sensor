...
copy_mw_lib -from ./mw_db/${TOP_MODULE}_route_opt -to $_mw_lib
...
write_def -nondefault_rule -rows_tracks_gcells -vias -all_vias -components -pins -blockages \
	-regions_groups -specialnets -nets -diode_pins -output ./outputs/${TOP_MODULE}.${step}.def
...
write_verilog -no_corner_pad_cells -no_pad_filler_cells -no_core_filler_cells \
	...
	-pg_ports -no_tap_cells -no_chip_cells -force_output_references $DECAP_FILLER \
	-split_bus ./outputs/${TOP_MODULE}_${step}_lvs.v
