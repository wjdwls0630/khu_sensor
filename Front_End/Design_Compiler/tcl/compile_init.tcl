...
# Reset
source "${tcl_path}Reset/async_rstn_synchronizer/async_rstn_synchronizer.tcl"
source "${tcl_path}Reset/async_rst_synchronizer/async_rst_synchronizer.tcl"
source "${tcl_path}Reset/async_rstn_glitch_synchronizer/async_rstn_glitch_synchronizer.tcl"
