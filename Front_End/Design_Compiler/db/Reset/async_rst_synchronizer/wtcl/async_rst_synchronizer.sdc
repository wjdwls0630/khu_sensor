...
# Created by write_sdc on Wed Jun 17 17:56:02 2020
...
set_fanout_load 13 [get_ports o_RST]
set_port_fanout_number 1241 [get_ports i_CLK]
set_port_fanout_number 2 [get_ports i_RSTN]
set_port_fanout_number 13 [get_ports o_RST]
set_load -pin_load 0 [get_ports i_CLK]
set_load -pin_load 0.00336 [get_ports i_RSTN]
set_load -pin_load 0.01035 [get_ports o_RST]
set_max_transition 1.5 [get_ports o_RST]
set_load -min -pin_load 0 [get_ports i_CLK]
set_load -min -pin_load 0.0035 [get_ports i_RSTN]
set_load -min -pin_load 0.02739 [get_ports o_RST]
