...
int main()
{
    ...
    */
     ...
     */
    sg.make_Signal();
    sg.write_Signal("../../../Data/All_Filters/Signal.txt");
    ...
    * temp = *sg.transmit();
    lpf.pass_LPF(* temp);
    lpf.write_Passed_Signal("../../../Data/All_Filters/IIR_LPF_Passed_Signal_CPP.txt");
    // write coefficient
    lpf.write_Coefficient("../../../Data/All_Filters/IIR_LPF_Coefficient.txt");
    delete temp;
    temp = nullptr;
    // passed notch
    ...
    * temp = *lpf.transmit();
    ...
    notch.write_Passed_Signal("../../../Data/All_Filters/IIR_Notch_Passed_Signal_CPP.txt");
    // write coefficient
    notch.write_Coefficient("../../../Data/All_Filters/IIR_Notch_Coefficient.txt");
    delete temp;
    temp = nullptr;
    ...
    * temp = *notch.transmit();
    hpf.pass_HPF(* temp);
    hpf.write_Passed_Signal("../../../Data/All_Filters/IIR_HPF_Passed_Signal_CPP.txt");
    // write coefficient
    hpf.write_Coefficient("../../../Data/All_Filters/IIR_HPF_Coefficient.txt");
    delete temp;
    temp = nullptr;
