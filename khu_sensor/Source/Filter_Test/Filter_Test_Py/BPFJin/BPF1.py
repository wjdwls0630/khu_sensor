...
if __name__ == "__main__":
    ...
    ax.annotate(rf'$f_cL$' + '={}Hz'.format(bpf.get_fcL()),
                ...
                xytext=(bpf.get_fcL() - 200, 0.5), textcoords='data', arrowprops=dict(arrowstyle="->", color='r'))
    ...
    ax.annotate('Nyquist rate' + "\n" + r'$\frac{f_s}{2}$' + "={}Hz".format(bpf.get_fs() / 2e3),
    ...
    ax.annotate(rf'$f_cL$' + '={}Hz'.format(bpf.get_fcL()),
                ...
                xytext=(bpf.get_fcL() - 200, -20), textcoords='data', arrowprops=dict(arrowstyle="->", color='r'))
    ax.axvline(x=450, color='r', linestyle='--')
    ax.annotate(rf'$f_cH$' + '={}Hz'.format(bpf.get_fcH()),
    ...
    ax.annotate('Nyquist rate' + "\n" + r'$\frac{f_s}{2}$' + "={}Hz".format(bpf.get_fs() / 2e3),
                xy=(bpf.get_fs() / 2, 0.5), color='g', xycoords='data',
                xytext=(bpf.get_fs() / 2 + 50, -80), textcoords='data', arrowprops=dict(arrowstyle="->", color='g'))
    ax.set_xlabel(r'$f$ (Hz)')
    ...
    pyplot.savefig("../data/BPF/BPF1.png")
    pyplot.show()
