...
if __name__ == "__main__":
    ...
    # create signal
    with open("../../../Data/IIR/LPF/IIR_LPF_Passed_Signal_CPP_1.txt", 'r') as dataFile:
    ...
    fig1.suptitle("IIR_LPF_Result_1")

    # Time Domain
    # ax = fig1.add_subplot(3, 1, 2)
    # ax.set(title="LPF_Passed_Signal_CPP_1")
    ax.plot(n, value, 'k', label=rf'IIR_LPF_Passed_Signal_CPP_1')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/LPF/IIR_LPF_Passed_Signal_CPP_1.png")
