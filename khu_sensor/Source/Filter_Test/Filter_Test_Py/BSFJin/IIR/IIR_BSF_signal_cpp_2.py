...
if __name__ == "__main__":
    ...
    # create signal
    with open("../../../Data/IIR/BSF/IIR_BSF_Passed_Signal_CPP_2.txt", 'r') as dataFile:
    ...
    fig1.suptitle("IIR_BSF_Result_2")

    # Time Domain
    # ax = fig1.add_subplot(3, 1, 2)
    # ax.set(title="LPF_Passed_Signal_CPP_1")
    ax.plot(n, value, 'k', label=rf'IIR_BSF_Passed_Signal_CPP_2')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/BSF/IIR_BSF_Passed_Signal_CPP_2.png")
