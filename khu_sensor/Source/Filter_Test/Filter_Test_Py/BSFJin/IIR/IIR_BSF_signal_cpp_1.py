...
if __name__ == "__main__":
    ...
    # create signal
    with open("../../../Data/IIR/BSF/IIR_BSF_Passed_Signal_CPP_1.txt", 'r') as dataFile:
    ...
    fig1.suptitle("IIR_BSF_Result_1")

    # Time Domain
    # ax = fig1.add_subplot(3, 1, 2)
    # ax.set(title="LPF_Passed_Signal_CPP_1")
    ax.plot(n, value, 'k', label=rf'IIR_BSF_Passed_Signal_CPP_1')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/BSF/IIR_BSF_Passed_Signal_CPP_1.png")
