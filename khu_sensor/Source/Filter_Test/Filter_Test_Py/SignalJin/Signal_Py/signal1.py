...
"""@package docstring
@brief	case 1 : signal without noise
...
if __name__ == "__main__":
    ...
    """
    t = numpy.linspace(0, 3/signal.get_fb(), 1500)
    ...
    """
    k2f_coeff = 1e5/1500
    ax.stem(k_ori*k2f_coeff, numpy.abs(numpy.fft.fft(x_original))/1500, 'k', markerfmt='ko',
            use_line_collection=True, label='Original')
    # cut the plot
    ax.set_xlim(0, 800)
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../data/signal/signal1.png")
