...
if __name__ == "__main__":
    ...
    # create signal
    with open("../../../Data/IIR/Signal/Signal_CPP_1.txt", 'r') as dataFile:
    ...
    ax.set(title="signal_cpp_1")
    ax.plot(n, value, 'k', label=rf'Signal_CPP_1')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/Signal/Signal_CPP_1.png")
