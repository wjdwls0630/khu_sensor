...
"""@package docstring
@brief	case 1 : 1 ~ 61 Hz included signal without noise
...
if __name__ == "__main__":
    ...
    """
    @brief	1 ~ 61 Hz included signal without noise 
    """

    # create signal
    with open("../../../Data/IIR/HPF/IIR_HPF_Passed_Signal_CPP_1.txt", 'r') as dataFile:
    ...
    fig1.suptitle("IIR_HPF_Result_1")

    # Time Domain
    # ax = fig1.add_subplot(3, 1, 2)
    # ax.set(title="LPF_Passed_Signal_CPP_1")
    ax.plot(n, value, 'k', label=rf'IIR_HPF_Passed_Signal_CPP_1')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/HPF/IIR_HPF_Passed_Signal_CPP_1.png")
