...
if __name__ == "__main__":
    ...
    # create signal
    with open("../../../Data/IIR/IIR_LPF/LPF_Passed_Signal_1.txt", 'r') as dataFile:
    ...
    fig1.suptitle("IIR_LPF_Passed_Signal_1")

    # Time Domain
    # ax = fig1.add_subplot(3, 1, 2)
    # ax.set(title="LPF_Passed_Signal_CPP_1")
    ax.plot(n, value, 'k', label=rf'LPF_Passed_Signal_1')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/IIR_LPF/LPF_Passed_Signal_1.png")
