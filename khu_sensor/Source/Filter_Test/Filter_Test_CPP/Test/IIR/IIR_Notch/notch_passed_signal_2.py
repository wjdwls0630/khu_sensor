...
"""@package docstring
@brief	case 2 : Being Passed IIR_LPF signal with SNR 116 passed IIR_Notch
...
if __name__ == "__main__":
    ...
    # create signal
    with open("../../../Data/IIR/IIR_Notch/Notch_Passed_Signal_2.txt", 'r') as dataFile:
    ...
    fig1.suptitle("IIR_Notch_Passed_Signal_2")

    # Time Domain
    # ax = fig1.add_subplot(3, 1, 2)
    # ax.set(title="LPF_Passed_Signal_CPP_1")
    ax.plot(n, value, 'k', label=rf'Notch_Passed_Signal_2')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/IIR_Notch/Notch_Passed_Signal_2.png")
