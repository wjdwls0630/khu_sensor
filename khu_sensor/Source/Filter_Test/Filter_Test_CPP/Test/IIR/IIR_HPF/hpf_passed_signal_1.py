...
if __name__ == "__main__":
    ...
    """
    @brief	1 ~ 66 Hz included signal without noise 
    """

    # create signal
    with open("../../../Data/IIR/IIR_HPF/HPF_Passed_Signal_1.txt", 'r') as dataFile:
    ...
    ax.plot(n, value, 'k', label=rf'HPF_Passed_Signal_1')
    ...
    ax.grid()
    ax.legend()
    pyplot.savefig("../../../Data/IIR/IIR_HPF/HPF_Passed_Signal_1.png")
