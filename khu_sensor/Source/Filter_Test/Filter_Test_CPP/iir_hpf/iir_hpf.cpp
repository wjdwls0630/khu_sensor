...
void iir_hpf::showOmega(){
    std::cout<<"HPF - Omega : \t"<<this->getOmega()<<'\n';
}
...
void iir_hpf::showFilterR(){
    std::cout<<"HPF - FilterR : \t"<<this->getFilterR()<<'\n';
}
...
void iir_hpf::showOmegaCal(){
    std::cout<<"HPF - OmegaCal : \t"<<this->getOmegaCal()<<'\n';
}
...
void iir_hpf::showInput(){
    std::cout<<"HPF - Input : \t"<<this->getInput()<<'\n';
}
...
void iir_hpf::showOutput(){
    std::cout<<"HPF - Output : \t"<<this->getOutput()<<'\n';
}
