...
# Created by write_sdc on Thu Sep  3 02:27:53 2020
...
-current mA
set_max_area 0
set_max_transition 0.9 [current_design]
set_disable_timing [get_ports i_RSTN]
set_load -pin_load 0.025 [get_ports UART_TXD]
set_load -pin_load 0.025 [get_ports MPR121_SCL]
set_load -pin_load 0.025 [get_ports MPR121_SDA]
set_load -pin_load 0.025 [get_ports ADS1292_SCLK]
set_load -pin_load 0.025 [get_ports ADS1292_MOSI]
set_load -pin_load 0.025 [get_ports ADS1292_RESET]
set_load -pin_load 0.025 [get_ports ADS1292_START]
set_load -pin_load 0.025 [get_ports ADS1292_CSN]
...
create_clock [get_ports i_CLK]  -name clk  -period 4.8  -waveform {0 2.4}
set_clock_latency 0.05  [get_clocks clk]
set_clock_latency -source 0.7  [get_clocks clk]
set_clock_uncertainty -setup 0.48  [get_clocks clk]
...
set_clock_uncertainty -setup 0.96  [get_clocks clk_half]
set_clock_uncertainty -hold 0.2  [get_clocks clk_half]
set_clock_transition -max -rise 0.8 [get_clocks clk_half]
set_clock_transition -min -rise 0.8 [get_clocks clk_half]
set_clock_transition -max -fall 0.8 [get_clocks clk_half]
set_clock_transition -min -fall 0.8 [get_clocks clk_half]
...
set_clock_uncertainty -hold 0.24  [get_pins                                                                     \
...
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/ads1292_filter/async_rst_synchronizer/o_RST_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/ads1292_filter/async_rst_synchronizer/r_ff_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/ads1292_filter/async_rstn_synchronizer/o_RSTN_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/ads1292_filter/async_rstn_synchronizer/r_ff_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins                                                                     \
...
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/mpr121_controller/async_rstn_synchronizer/r_ff_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/sensor_core/async_rst_synchronizer/o_RST_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/sensor_core/async_rst_synchronizer/r_ff_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins                                                                     \
...
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/uart_controller/async_rstn_synchronizer/o_RSTN_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/uart_controller/async_rstn_synchronizer/r_ff_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/uart_controller/async_rst_synchronizer/o_RST_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins khu_sensor_top/uart_controller/async_rst_synchronizer/r_ff_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins                                                                     \
...
set_clock_uncertainty -hold 0.24  [get_pins async_rstn_glitch_synchronizer/async_rstn_synchronizer/o_RSTN_reg/CK]
set_clock_uncertainty -hold 0.24  [get_pins async_rstn_glitch_synchronizer/async_rstn_synchronizer/r_ff_reg/CK]
