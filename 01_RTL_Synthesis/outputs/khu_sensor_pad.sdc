...
# Created by write_sdc on Sat Sep  5 05:21:15 2020
...
create_clock [get_ports i_CLK]  -name clk  -period 6  -waveform {0 3}
set_clock_latency 0.05  [get_clocks clk]
set_clock_latency -source 0.7  [get_clocks clk]
set_clock_uncertainty -setup 1.98  [get_clocks clk]
...
set_clock_uncertainty -setup 3.96  [get_clocks clk_half]
...
[get_ports MPR121_SDA] [get_ports ADS1292_MISO] [get_ports ADS1292_DRDY]]  -to [list [get_ports CLK_OUT] [get_ports UART_TXD] [get_ports MPR121_SCL]     \
[get_ports MPR121_SDA] [get_ports ADS1292_SCLK] [get_ports ADS1292_MOSI]       \
[get_ports ADS1292_RESET] [get_ports ADS1292_START] [get_ports ADS1292_CSN]]
...
group_path -name REGOUT  -to [list [get_ports CLK_OUT] [get_ports UART_TXD] [get_ports MPR121_SCL]     \
[get_ports MPR121_SDA] [get_ports ADS1292_SCLK] [get_ports ADS1292_MOSI]       \
[get_ports ADS1292_RESET] [get_ports ADS1292_START] [get_ports ADS1292_CSN]]
set_false_path   -from [get_ports i_RSTN]
set_false_path   -from [get_pins                                                               \
async_rstn_glitch_synchronizer/async_rstn_synchronizer/o_RSTN_reg/Q]
set_false_path   -to [get_pins                                                                 \
async_rstn_glitch_synchronizer/async_rstn_synchronizer/o_RSTN_reg/D]
set_false_path   -to [get_pins                                                                 \
...
khu_sensor_top/async_rstn_glitch_synchronizer/async_rstn_synchronizer/o_RSTN_reg/Q] \
[get_pins khu_sensor_top/uart_controller/async_rstn_synchronizer/o_RSTN_reg/Q] \
[get_pins                                                                      \
khu_sensor_top/mpr121_controller/async_rstn_synchronizer/o_RSTN_reg/Q]         \
[get_pins khu_sensor_top/ads1292_filter/async_rstn_synchronizer/o_RSTN_reg/Q]  \
[get_pins                                                                      \
khu_sensor_top/ads1292_controller/async_rstn_synchronizer/o_RSTN_reg/Q]]
set_false_path   -to [list [get_pins                                                           \
khu_sensor_top/async_rstn_glitch_synchronizer/async_rstn_synchronizer/o_RSTN_reg/D] \
[get_pins khu_sensor_top/uart_controller/async_rstn_synchronizer/o_RSTN_reg/D] \
[get_pins                                                                      \
khu_sensor_top/mpr121_controller/async_rstn_synchronizer/o_RSTN_reg/D]         \
[get_pins khu_sensor_top/ads1292_filter/async_rstn_synchronizer/o_RSTN_reg/D]  \
[get_pins                                                                      \
khu_sensor_top/ads1292_controller/async_rstn_synchronizer/o_RSTN_reg/D]]
set_false_path   -to [list [get_pins                                                           \
...
khu_sensor_top/ads1292_controller/spi_master/async_rstn_synchronizer/o_RSTN_reg/Q]]
set_false_path   -to [list [get_pins                                                           \
khu_sensor_top/mpr121_controller/i2c_master/async_rstn_synchronizer/o_RSTN_reg/D] \
[get_pins                                                                      \
khu_sensor_top/ads1292_filter/iir_lpf/async_rstn_synchronizer/o_RSTN_reg/D]    \
[get_pins                                                                      \
khu_sensor_top/ads1292_filter/iir_notch/async_rstn_synchronizer/o_RSTN_reg/D]  \
[get_pins                                                                      \
khu_sensor_top/ads1292_filter/iir_hpf/async_rstn_synchronizer/o_RSTN_reg/D]    \
[get_pins                                                                      \
khu_sensor_top/ads1292_controller/spi_master/async_rstn_synchronizer/o_RSTN_reg/D]]
set_false_path   -from [list [get_pins                                                         \
khu_sensor_top/uart_controller/async_rst_synchronizer/o_RST_reg/Q] [get_pins   \
khu_sensor_top/sensor_core/async_rst_synchronizer/o_RST_reg/Q] [get_pins       \
khu_sensor_top/ads1292_filter/async_rst_synchronizer/o_RST_reg/Q]]
set_false_path   -to [list [get_pins                                                           \
khu_sensor_top/uart_controller/async_rst_synchronizer/o_RST_reg/D] [get_pins   \
khu_sensor_top/sensor_core/async_rst_synchronizer/o_RST_reg/D] [get_pins       \
khu_sensor_top/ads1292_filter/async_rst_synchronizer/o_RST_reg/D]]
set_false_path   -to [list [get_pins                                                           \
