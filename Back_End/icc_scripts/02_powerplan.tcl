...
copy_mw_lib -from ./mw_db/${TOP_MODULE}_floorplan -to $_mw_lib
...
#	-max_strap 50 -min_strap 16 -max_width 3 -min_width 0.400 \
#	-spacing minimum

#set_fp_rail_constraints \
#	-add_layer  -layer MET4 -direction vertical \
...
#set_fp_rail_constraints  -set_ring -nets {VDD VSS} \
	-horizontal_ring_layer { MET3 } -vertical_ring_layer { MET2 } 
	 
#set_fp_rail_constraints -set_global -no_routing_over_hard_macros

#synthesize_fp_rail \
	-nets {VDD VSS} -voltage_supply 1.35 \
	-synthesize_power_plan -power_budget 350 -pad_masters {  vdd12ih vssih  }
...
create_rectangular_rings \
	-nets {VDD VSS} \
	-left_offset 375 -left_segment_layer MET6 -left_segment_width 5 \
	-right_offset 375 -right_segment_layer MET6 -right_segment_width 5 \
	-bottom_offset 345 -bottom_segment_layer MET5 -bottom_segment_width 5 \
	-top_offset 345 -top_segment_layer MET5 -top_segment_width 5
...
create_route_guide \
	...
	-coordinate {{540.710 780.910} {640.710 980.510}} -no_snap
