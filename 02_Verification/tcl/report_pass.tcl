...
report_matched_points > "${log_path}${dir}${tcl_path}${status}${design}_report_matched_points.rpt"

# report info about compare points that passed the most recent verification
report_passing_points > "${log_path}${dir}${tcl_path}${status}${design}_report_passing_points.rpt"
